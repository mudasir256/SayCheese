// Constants for Reviews component

// Content
export const SECTION_TITLE = 'WHAT PARENTS SAY';
export const SECTION_DESCRIPTION = "Don't just take our word for it - hear from the families we've had the privilege to serve";
export const GOOGLE_RATING = '5.0/5 Star Rating';
export const REVIEW_COUNT = '633+';
export const SCROLLING_TEXT = "CHILDREN'S DENTAL SERVICES";

// Timing
export const CAROUSEL_INTERVAL = 5000; // 5 seconds
export const SCROLL_ANIMATION_DURATION = 30; // 30 seconds
