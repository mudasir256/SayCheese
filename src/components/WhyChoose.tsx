        ...
        <div className="min-h-screen" style={{ backgroundColor: '#f4f3ef' }}>
            <div className="  px-4 sm:px-6 lg:px-16 py-12">
                ...
                <div className="text-center mb-16 ">
                    ...
                    {/* ABC Blocks decoration */}
                    <div className="absolute -top-4 right-0 md:right-20">
                        <svg width="80" height="80" viewBox="0 0 80 80" className="opacity-80">
                            <rect x="5" y="5" width="25" height="25" fill="none" stroke="#e8a5a5" strokeWidth="2" rx="3" transform="rotate(15 17.5 17.5)" />
                            <text x="17.5" y="22" textAnchor="middle" fontSize="16" fill="#e8a5a5" fontWeight="bold">1</text>

                            <rect x="35" y="0" width="25" height="25" fill="none" stroke="#e8a5a5" strokeWidth="2" rx="3" transform="rotate(-10 47.5 12.5)" />
                            <text x="47.5" y="17" textAnchor="middle" fontSize="16" fill="#e8a5a5" fontWeight="bold">2</text>

                            <rect x="50" y="30" width="25" height="25" fill="none" stroke="#e8a5a5" strokeWidth="2" rx="3" transform="rotate(8 62.5 42.5)" />
                            <text x="62.5" y="47" textAnchor="middle" fontSize="16" fill="#e8a5a5" fontWeight="bold">3</text>
                        </svg>
                    </div>
                </div>
                        ...
                        <div className="bg-amber-50 rounded-2xl p-8 shadow-lg ">
                            ...
                            <div className="space-y-4">
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-lg bg-white border border-gray-200 focus:outline-none focus:ring-2 focus:ring-yellow-400 text-gray-700 placeholder-gray-400"
                                />
                                ...
                                <select
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-4 py-3 rounded-lg bg-white border border-gray-200 focus:outline-none focus:ring-2 focus:ring-yellow-400 text-gray-700 appearance-none cursor-pointer"
                                ...
                                <button
                                    ...
                                    className="w-full py-4 rounded-full text-white font-bold text-lg shadow-lg hover:shadow-xl transition-shadow duration-300"
